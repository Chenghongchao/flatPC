...
.controller('unusualentryLdCtrl', ['$scope','$rootScope','AppConfig',function($scope,$rootScope,AppConfig) {
    ...
    $("#mainframe",parent.document.body).attr("src", AppConfig.FRAME+"index.php?m=ExitManagement&c=Abnormal&a=unusual&token="+AppConfig.token+"&schoolcode="+AppConfig.schoolCode)
    a.target="page-frame";
    a.click();
}]);