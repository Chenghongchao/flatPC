...
.controller('StudentCtrl', ['$scope','$rootScope','AppConfig',function($scope,$rootScope,AppConfig) {
    ...
    $("#mainframe",parent.document.body).attr("src", AppConfig.FRAME + "index.php?m=Coredata&c=CollegeClass&a=student&token="+AppConfig.token+"&schoolcode="+AppConfig.schoolCode)
    a.target="page-frame";
    a.click();
}]);