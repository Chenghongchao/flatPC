...
.controller('bedroomCheckSetCtrl', ['$scope','$rootScope','AppConfig',function($scope,$rootScope,AppConfig) {
    ...
    $("#mainframe",parent.document.body).attr("src", AppConfig.FRAME+"index.php?m=RoomCheck&c=BasicsSetting&a=index&token="+AppConfig.token+"&schoolcode="+AppConfig.schoolCode) 
    a.target="page-frame";
    a.click();
}]);